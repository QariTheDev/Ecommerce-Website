...
import { fetchProducts } from '../Redux/Slices/Products/ElectronicSlice';
    ...
    return (
        <>
            <div className='relative flex flex-col bg-white dark:bg-black items-center justify-center overflow-hidden'>
                <h1 className='text-4xl font-bold text-textColor dark:text-textColorDark mb-3 pt-3'>Electronics</h1>
                                        ...
                                        <div className="p-6">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center space-x-1">
                                                    ...
                                                    <span className="text-gray-600 dark:text-gray-300">{product.rating.rate} ({product.rating.count})</span>
                                                </div>
