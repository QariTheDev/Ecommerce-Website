...
import { fetchProducts } from '../Redux/Slices/Products/WomenWearSlice';
import { useNavigate } from 'react-router-dom';

export default function WomenClothing() {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const { products, loading, error } = useSelector(state => state.womenWear);
    ...
    return (
        <>
            <div className='relative flex flex-col bg-white dark:bg-black items-center justify-center overflow-hidden'>
                <h1 className='text-4xl font-bold text-textColor dark:text-textColorDark mb-3 pt-3'>Women's Wear</h1>
